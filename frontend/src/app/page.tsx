        ...
        <div className="container mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <div className="space-y-8 animate-slideUp">
              ...
              {/* Contact Details */}
              <div className="space-y-4">
                <a href="tel:+908505321518" className="flex items-center gap-4 p-4 glass-effect rounded-xl hover:bg-white/10 transition-all group">
                  ...
                  <div>
                    ...
                    <p className="text-white font-semibold text-lg">+90 850 532 15 18</p>
                  </div>
                </a>
                ...
                <a href="https://wa.me/908505321518" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 glass-effect rounded-xl hover:bg-white/10 transition-all group">
