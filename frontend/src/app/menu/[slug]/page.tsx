...
export default function PublicMenu() {
  ...
  return (
    <div className="min-h-screen relative" style={{ backgroundColor: theme.backgroundColor }}>
      ...
      {/* Social Media & Contact Bar - Fixed Bottom - Compact Action Strip */}
      <div 
        className="fixed bottom-0 left-0 right-0 shadow-md z-50"
        style={{ 
        ...
        <div className="max-w-4xl mx-auto px-3 py-2">
          <div className="flex items-center justify-center gap-6">
            ...
            <a 
              ...
              className="flex flex-col items-center gap-1 px-4 py-1.5 rounded-xl transition-all hover:opacity-80 active:scale-95"
              style={{ color: theme.preset === 'dark' ? '#F3F4F6' : '#374151' }}
            >
              <div className="w-9 h-9 rounded-full flex items-center justify-center shadow-sm" style={{ backgroundColor: '#25D366' }}>
            ...
            <a 
              ...
              style={{ color: theme.preset === 'dark' ? '#F3F4F6' : '#374151' }}
            >
              <div className="w-9 h-9 rounded-full flex items-center justify-center shadow-sm" style={{ backgroundColor: '#3B82F6' }}>
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/>
                </svg>
              </div>
              <span className="text-[11px] font-medium leading-tight">Ara</span>
            </a>
            ...
            <a 
              ...
              style={{ color: theme.preset === 'dark' ? '#F3F4F6' : '#374151' }}
            >
              <div className="w-9 h-9 rounded-full flex items-center justify-center shadow-sm" style={{ backgroundColor: '#EF4444' }}>
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
                </svg>
              </div>
              <span className="text-[11px] font-medium leading-tight">Konum</span>
            </a>
            ...
            {restaurant.instagramUrl && (
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center gap-1 px-3 py-1.5 rounded-xl transition-all hover:opacity-80 active:scale-95"
                style={{ color: theme.preset === 'dark' ? '#F3F4F6' : '#374151' }}
              >
                ...
                <span className="text-[10px] font-medium leading-tight">Instagram</span>
              </a>
            )}
            ...
            {restaurant.facebookUrl && (
              <a 
                ...
                style={{ color: theme.preset === 'dark' ? '#F3F4F6' : '#374151' }}
              >
                <div className="w-8 h-8 rounded-full flex items-center justify-center shadow-sm" style={{ backgroundColor: '#1877F2' + '30' }}>
