            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                {restaurant.workingHours && (
                  <div 
                    className="flex items-center gap-1.5 text-sm drop-shadow mt-1"
                    style={{
                      color: buildTheme(restaurant.themeSettings).headerBackgroundType === 'gradient' || buildTheme(restaurant.themeSettings).showHeaderOverlay
                        ? '#ffffff'
                        : '#6B7280'
        ...
        <div className="max-w-4xl mx-auto px-4 py-3">
          <div className="flex items-center justify-around gap-2">
            ...
            <button 
              ...
              style={{ 
                color: theme.preset === 'dark' ? '#F3F4F6' : '#374151'
              }}
            >
              <div 
              ...
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" style={{ color: theme.primaryColor }}>
            ...
            >
              <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: '#25D366' + '30' }}>
            ...
            <a 
              ...
              style={{ color: theme.preset === 'dark' ? '#F3F4F6' : '#374151' }}
            >
              <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: theme.secondaryColor + '30' }}>
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" style={{ color: theme.secondaryColor }}>
                  <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/>
                </svg>
              </div>
              <span className="text-xs text-gray-600 font-medium">Ara</span>
            </a>
            ...
            <a 
              ...
              style={{ color: theme.preset === 'dark' ? '#F3F4F6' : '#374151' }}
            >
              <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: '#EF4444' + '30' }}>
